...
typedef void(__thiscall* try_open_t)(void* this_, void* archive, int u1, int u2, blt::idstring type, blt::idstring name);

static void hook_load(try_open_t orig, subhook::Hook& hook, void* this_, void* archive, int u1, int u2, blt::idstring type, blt::idstring name);

#define DECLARE_PASSTHROUGH(func)                                                                                          \
	static subhook::Hook hook_##func;                                                                                        \
	void __fastcall stub_##func(void* this_, int edx, void* archive, int u1, int u2, blt::idstring type, blt::idstring name) \
	{                                                                                                                        \
...
#define DECLARE_PASSTHROUGH_ARRAY(id)                                                                                    \
	...
	void __fastcall stub_##id(void* this_, int edx, void* archive, int u1, int u2, blt::idstring type, blt::idstring name) \
	{                                                                                                                      \
