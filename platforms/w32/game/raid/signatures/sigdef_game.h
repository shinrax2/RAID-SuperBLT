CREATE_CALLABLE_CLASS_SIGNATURE(luaL_newstate_exe, int, "\x48\x89\x5C\x24\x08\x48\x89\x74\x24\x10\x57\x48\x83\xEC\x20\x41\x0F\xB6\xF8\x0F\xB6\xF2", "xxxxxxxxxxxxxxxxxxxxxx", 0, char, char, int)
